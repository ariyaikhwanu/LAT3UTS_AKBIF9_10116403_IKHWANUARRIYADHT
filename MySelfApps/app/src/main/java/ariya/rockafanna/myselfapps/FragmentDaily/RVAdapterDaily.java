...
public class RVAdapterDaily extends RecyclerView.Adapter<RVAdapterDaily.MahasiswaViewHolder> {

    private ArrayList<ListDataDaily> dataList;


    public RVAdapterDaily(ArrayList<ListDataDaily> dataList) {
    ...
    public MahasiswaViewHolder onCreateViewHolder(ViewGroup container, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.view_rv_daily, container, false);
