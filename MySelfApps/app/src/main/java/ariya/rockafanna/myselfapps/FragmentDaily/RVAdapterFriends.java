...
public class RVAdapterFriends extends RecyclerView.Adapter<RVAdapterFriends.MahasiswaViewHolder> {

    private ArrayList<ListDataFriends> dataList;


    public RVAdapterFriends(ArrayList<ListDataFriends> dataList) {
    ...
    public MahasiswaViewHolder onCreateViewHolder(ViewGroup container, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.view_rv_firends, container, false);
